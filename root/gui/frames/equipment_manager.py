...
#         add_button = ttk.Button(header, text="➕", style='ToolButton.TButton', command=self.add_equipment_dialog)
#         add_button.pack(anchor="e", pady=2, padx=2)
...
#         # self.equipment_used -> self.report.get_equipment_used()
#         for row_index, row in self.report.cover_page.equipment_used.iterrows():
#             var = tk.BooleanVar()
#             # self.checkbox_vars -> self.report.selected_test.checkbox_vars
#             self.report.selected_test.checkbox_vars.append(var)
...
#             self.report.cover_page.equipment_used.loc[len(self.report.cover_page.equipment_used)] = values
#             editor.destroy()
#             self.refresh_ui()
...
#         row_data = self.report.cover_page.equipment_used.iloc[index]
...
#                 # self.equipment_used -> self.report.get_equipment_used()
#                 # self.equipment_used -> self.report.cover_page.equipment_used
#                 self.report.cover_page.equipment_used.at[index, field] = entries[field].get()
#             editor.destroy()
#             self.refresh()
...
#         # self.equipment_used -> self.report.cover_page.equipment_used
#         def delete():
#             self.report.cover_page.equipment_used.drop(self.equipment_used.index[index], inplace=True)
#             self.report.cover_page.equipment_used.reset_index(drop=True, inplace=True)
#             editor.destroy()
#             self.refresh()
...
#             widget.destroy()
#         # self.checkbox_vars -> self.report.selected_test.checkbox_vars
#         self.report.selected_test.checkbox_vars.clear()
#         self.build_equipment_list()
